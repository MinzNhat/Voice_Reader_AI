...
interface ApiService {
    ...
    @POST(ApiConstants.Endpoints.RAG_ASK)
    suspend fun askQuestion(@Body request: RagRequest): Response<RagResponse>

    @POST(ApiConstants.Endpoints.SUMMARY)
    suspend fun summary(@Body request: RagRequest): Response<RagResponse>
