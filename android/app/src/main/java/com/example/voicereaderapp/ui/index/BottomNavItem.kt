...
sealed class Screen(val route: String) {
    ...
    object DocumentPicker : Screen("document_picker")
    object PDFViewer : Screen("pdf_viewer/{fileUri}") {
        fun createRoute(fileUri: String) = "pdf_viewer/${android.net.Uri.encode(fileUri)}"
    }
}
